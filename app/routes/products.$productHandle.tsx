...
async function loadCriticalData({
  ...
  const [{product}] = await Promise.all([
    storefront.query(PRODUCT_QUERY, {
      variables: {handle: productHandle, selectedOptions: getSelectedProductOptions(request)},
    }),
      ...
      <div className='max-w-7xl mx-auto px-4 md:px-8'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16'>
          ...
          <div className='space-y-8'>
            <ProductImage
            images = {
              product.images.nodes.map((node: any) => ({
                id: node.id,
                url: node.url,
          ...
          <div className='space-y-10'>
            ...
            <div className='space-y-4 border-b border-gray-300 pb-6'>
              <h1 className='font-family-playfair text-3xl md:text-4xl lg:text-5xl text-brand-navy'>
                {product.title}
              </h1>
              ...
              <ProductPrice 
                 ...
                 className='font-family-source text-xl text-brand-navy'
              />  
            </div>
            ...
            {/* Product Description */}
            <div className='font-family-source text-brand-navy/80 max-w-none'>
