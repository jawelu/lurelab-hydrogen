        ...
        <div className='container mx-auto'>
          <div className='max-w-3xl mx-auto'>
            <div className='max-w-none'>
              <div className='font-family-source text-brand-navy/80 text-lg md:text-xl leading-relaxed'>
              ...
              <div
                className="font-family-source text-brand-navy/80"
                dangerouslySetInnerHTML={{
                  __html: page.body
                    .replace(
                      /<h2>/g,
                      '<h2 class="font-family-playfair text-2xl text-brand-navy mt-16 mb-8">'
                    )
                    .replaceAll(
                      /<h3>/g,
                      '<h3 class="font-family-playfair text-xl text-brand-navy mt-12 mb-4">'
                    ),
                }}
              />
            </div>
            ...
            <div className='container mx-auto'>
              <div className='max-w-3xl mx-auto'>
                ...
                <Link
                  to="/contact"
                  prefetch="intent"
                  className="inline-flex items-center px-8 py-4 mt-8 bg-brand-navy text-white hover:bg-brand-navyLigh
                 transition-colors duration-300 font-family-source tracking-wide
                 "
                >
