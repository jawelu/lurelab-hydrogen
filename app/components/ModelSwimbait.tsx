...
export default function ModelSwimbait() {
      const mesh = useRef<THREE.Mesh>(null);
    const { nodes, scene } = useGLTF("/scene/swimbait.glb")
...
// mesh.current.rotation.z += 0.001; // 绕 Z 轴旋转
    ...
    return (
        <group>
            ...
            {/* swimbait_productdraft2 */}

          {/* <mesh {...nodes["swimbait_productdraft2"]}  ref={mesh}>
                 <meshStandardMaterial color="red" />
            </mesh> */}
            
      
            <primitive ref={mesh} object={scene} scale={0.06} />
        </group>
    )
}
